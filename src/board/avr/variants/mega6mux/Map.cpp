        ...
        namespace map
        {
            namespace
            {
                const core::io::mcuPin_t aInPins[NUMBER_OF_MUX] = {
                    ...
                    CORE_IO_MCU_PIN_DEF(MUX_3_IN_PORT, MUX_3_IN_PIN),
                    CORE_IO_MCU_PIN_DEF(MUX_4_IN_PORT, MUX_4_IN_PIN),
                    CORE_IO_MCU_PIN_DEF(MUX_5_IN_PORT, MUX_5_IN_PIN),
                    CORE_IO_MCU_PIN_DEF(MUX_6_IN_PORT, MUX_6_IN_PIN)
                };
