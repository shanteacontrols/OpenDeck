    ...
    namespace detail
    {
        namespace setup
        {
            void io()
            {
                ...
                CORE_IO_CONFIG(PORTD, 2, core::io::pinMode_t::output);
                CORE_IO_CONFIG(PORTD, 4, core::io::pinMode_t::output);
                ...
                CORE_IO_CONFIG(PORTF, 7, core::io::pinMode_t::output);
                ...
                CORE_IO_SET_LOW(PORTD, 2);
                CORE_IO_SET_LOW(PORTD, 4);
            ...
            void adc()
            {
                core::adc::disconnectDigitalIn(Board::detail::map::adcChannel(0).index);
                core::adc::disconnectDigitalIn(Board::detail::map::adcChannel(1).index);
                core::adc::disconnectDigitalIn(Board::detail::map::adcChannel(2).index);
