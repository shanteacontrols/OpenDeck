        ...
        namespace map
        {
            namespace
            {
                const core::io::mcuPin_t aInPins[MAX_NUMBER_OF_ANALOG] = {
                    ...
                    CORE_IO_MCU_PIN_DEF(AI_7_PORT, AI_7_PIN),
                    CORE_IO_MCU_PIN_DEF(AI_8_PORT, AI_8_PIN),
                    CORE_IO_MCU_PIN_DEF(AI_9_PORT, AI_9_PIN),
                    CORE_IO_MCU_PIN_DEF(AI_10_PORT, AI_10_PIN),
                    CORE_IO_MCU_PIN_DEF(AI_11_PORT, AI_11_PIN),
                    CORE_IO_MCU_PIN_DEF(AI_12_PORT, AI_12_PIN),
                    CORE_IO_MCU_PIN_DEF(AI_13_PORT, AI_13_PIN),
                    CORE_IO_MCU_PIN_DEF(AI_14_PORT, AI_14_PIN),
                    CORE_IO_MCU_PIN_DEF(AI_15_PORT, AI_15_PIN),
                    CORE_IO_MCU_PIN_DEF(AI_16_PORT, AI_16_PIN)
                };
