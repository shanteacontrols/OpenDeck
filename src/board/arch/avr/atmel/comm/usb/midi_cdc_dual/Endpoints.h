...
#define MIDI_STREAM_IN_EPADDR   (USB_ENDPOINT_DIR_IN | 3)
#define MIDI_STREAM_OUT_EPADDR  (USB_ENDPOINT_DIR_OUT | 4)
#define CDC_NOTIFICATION_EPADDR (USB_ENDPOINT_DIR_IN | 5)
