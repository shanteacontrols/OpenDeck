...
#include "board/src/common/communication/usb/descriptors/midi/Descriptors.h"
...
{
    Endpoint_ConfigureEndpoint(USB_ENDPOINT_MIDI_ADDR_IN, core::mcu::usb::ENDPOINT_TYPE_BULK, USB_ENDPOINT_MIDI_SIZE_IN_OUT, 1);
    Endpoint_ConfigureEndpoint(USB_ENDPOINT_MIDI_ADDR_OUT, core::mcu::usb::ENDPOINT_TYPE_BULK, USB_ENDPOINT_MIDI_SIZE_IN_OUT, 1);
}
...
namespace board
{
    namespace detail::usb
    {
        void init()
        {
            ...
            _midiInterface.Config.DataINEndpoint.Size      = USB_ENDPOINT_MIDI_SIZE_IN_OUT;
            _midiInterface.Config.DataINEndpoint.Banks     = 1;
            _midiInterface.Config.DataOUTEndpoint.Address  = USB_ENDPOINT_MIDI_ADDR_OUT;
            _midiInterface.Config.DataOUTEndpoint.Size     = USB_ENDPOINT_MIDI_SIZE_IN_OUT;
