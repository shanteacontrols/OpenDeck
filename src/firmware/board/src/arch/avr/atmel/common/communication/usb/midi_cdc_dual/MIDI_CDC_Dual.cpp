...
namespace board
{
    namespace detail::usb
    {
        void init()
        {
            ...
            _cdcInterface.Config.DataINEndpoint.Address       = PROJECT_MCU_USB_ENDPOINT_MIDI_CDC_DUAL_ADDR_CDC_IN;
            _cdcInterface.Config.DataINEndpoint.Size          = PROJECT_MCU_USB_ENDPOINT_SIZE_CDC_IN_OUT;
            _cdcInterface.Config.DataINEndpoint.Banks         = 1;
            _cdcInterface.Config.DataOUTEndpoint.Address      = PROJECT_MCU_USB_ENDPOINT_MIDI_CDC_DUAL_ADDR_CDC_OUT;
            _cdcInterface.Config.DataOUTEndpoint.Size         = PROJECT_MCU_USB_ENDPOINT_SIZE_CDC_IN_OUT;
            _cdcInterface.Config.DataOUTEndpoint.Banks        = 1;
            _cdcInterface.Config.NotificationEndpoint.Address = PROJECT_MCU_USB_ENDPOINT_MIDI_CDC_DUAL_ADDR_CDC_NOTIFICATION;
            _cdcInterface.Config.NotificationEndpoint.Size    = PROJECT_MCU_USB_ENDPOINT_SIZE_CDC_NOTIFICATION;
            ...
            _midiInterface.Config.DataINEndpoint.Address      = PROJECT_MCU_USB_ENDPOINT_MIDI_CDC_DUAL_ADDR_MIDI_IN;
            ...
            _midiInterface.Config.DataOUTEndpoint.Address     = PROJECT_MCU_USB_ENDPOINT_MIDI_CDC_DUAL_ADDR_MIDI_OUT;
