...
PROJECT_PRESETS_FILE := $(ZENV_PROJECT_ROOT)/app/presets.yml
NON_TARGET_GOALS     := clean clean-all format print-%
OPENDECK_OVERLAYS    := $(sort $(wildcard $(ZENV_PROJECT_ROOT)/app/boards/opendeck/*/firmware.overlay))
...
OPENDECK_OVERLAY := $(ZENV_PROJECT_ROOT)/app/boards/opendeck/$(TARGET)/firmware.overlay
