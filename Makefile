...
OPENDECK_OVERLAYS    := $(sort $(wildcard $(ZEPHYR_PROJECT)/app/boards/opendeck/*/firmware.overlay))
...
OPENDECK_OVERLAY := $(ZEPHYR_PROJECT)/app/boards/opendeck/$(TARGET)/firmware.overlay
