...
then
    ...
    then
...

        {
            ...
            printf "%s\n" "list(APPEND $cmake_usb_defines_var PROJECT_MCU_USB_ENDPOINT_SIZE_CDC_IN_OUT=$usb_endpoint_size_cdc_in_out)"
            printf "%s\n" "list(APPEND $cmake_usb_defines_var PROJECT_MCU_USB_ENDPOINT_SIZE_CDC_NOTIFICATION=$usb_endpoint_size_cdc_notification)"
        } >> "$out_cmakelists"
        ...
        # tinyusb only
        {
            ...
            printf "%s\n" "list(APPEND $cmake_usb_defines_var CFG_TUD_CDC_EP_BUFSIZE=$usb_endpoint_size_cdc_in_out)"
        } >> "$out_cmakelists"
    fi
    ...
    then
        ...
        {
            printf "%s\n" "list(APPEND $cmake_usb_defines_var PROJECT_MCU_USB_ENDPOINT_MIDI_CDC_DUAL_ADDR_CDC_IN=$usb_endpoint_midi_cdc_dual_addr_cdc_in)"
            printf "%s\n" "list(APPEND $cmake_usb_defines_var PROJECT_MCU_USB_ENDPOINT_MIDI_CDC_DUAL_ADDR_CDC_OUT=$usb_endpoint_midi_cdc_dual_addr_cdc_out)"
            printf "%s\n" "list(APPEND $cmake_usb_defines_var PROJECT_MCU_USB_ENDPOINT_MIDI_CDC_DUAL_ADDR_CDC_NOTIFICATION=$usb_endpoint_midi_cdc_dual_addr_cdc_notification)"
            printf "%s\n" "list(APPEND $cmake_usb_defines_var PROJECT_MCU_USB_ENDPOINT_MIDI_CDC_DUAL_ADDR_MIDI_IN=$usb_endpoint_midi_cdc_dual_addr_midi_in)"
            printf "%s\n" "list(APPEND $cmake_usb_defines_var PROJECT_MCU_USB_ENDPOINT_MIDI_CDC_DUAL_ADDR_MIDI_OUT=$usb_endpoint_midi_cdc_dual_addr_midi_out)"
        } >> "$out_cmakelists"
    fi
    ...
    then
        ...
        # tinyusb only
        {
            ...
            printf "%s\n" "list(APPEND $cmake_usb_defines_var CFG_TUD_CDC_TX_BUFSIZE=$usb_buffer_cdc_tx)"
            printf "%s\n" "list(APPEND $cmake_usb_defines_var CFG_TUD_CDC_RX_BUFSIZE=$usb_buffer_cdc_rx)"
        } >> "$out_cmakelists"
    fi
fi