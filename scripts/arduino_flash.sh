...
then
    ...
    avrdude -p atmega8u2 -P /dev/$port -b 19200 -c avrisp -U flash:w:../src/build/fw_8u2.bin -U lock:w:0xef:m
elif [ $board == 2 ]
then
    ...
    avrdude -p atmega16u2 -P /dev/$port -b 19200 -c avrisp -U flash:w:../src/build/fw_16u2.bin -U lock:w:0xef:m
elif [ $board == 3 ]
then
    ...
    avrdude -p atmega328p -P /dev/$port -b 19200 -c avrisp -U flash:w:../src/build/fw_uno.bin -U lock:w:0xef:m
elif [ $board == 4 ]
then
    ...
    avrdude -p atmega2560 -P /dev/$port -b 19200 -c avrisp -U flash:w:../src/build/fw_mega.bin -U lock:w:0xef:m
elif [ $board == 5 ]
then
    ...
    avrdude -p atmega32u4 -P /dev/$port -b 19200 -c avrisp -U flash:w:../src/build/fw_leonardo.bin -U lock:w:0xef:m
elif [ $board == 6 ]
then
