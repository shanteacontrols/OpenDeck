...
then
    ...
    avrdude -C /etc/avrdude.conf -p atmega8u2 -P /dev/$port -b 19200 -c avrisp -U flash:w:../src/build/fw_8u2.bin -U lock:w:0x2f:m
elif [ $board == 2 ]
then
    ...
    avrdude -C /etc/avrdude.conf -p atmega16u2 -P /dev/$port -b 19200 -c avrisp -U flash:w:../src/build/fw_16u2.bin -U lock:w:0x2f:m
elif [ $board == 3 ]
then
    ...
    avrdude -C /etc/avrdude.conf -p atmega328p -P /dev/$port -b 19200 -c avrisp -U flash:w:../src/build/fw_uno.bin -U lock:w:0x2f:m
elif [ $board == 4 ]
then
    ...
    avrdude -C /etc/avrdude.conf -p atmega2560 -P /dev/$port -b 19200 -c avrisp -U flash:w:../src/build/fw_mega.bin -U lock:w:0x2f:m
elif [ $board == 5 ]
then
    ...
    avrdude -C /etc/avrdude.conf -p atmega32u4 -P /dev/$port -b 19200 -c avrisp -U flash:w:../src/build/fw_leonardo.bin -U lock:w:0x2f:m
elif [ $board == 6 ]
then
    ...
    avrdude -C /etc/avrdude.conf -p atmega32u4 -P /dev/$port -b 19200 -c avrisp -U flash:w:../src/build/fw_pro_micro.bin -U lock:w:0x2f:m
else
