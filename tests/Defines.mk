...
ARCH := $(shell find ../src/board/ -type d ! -path *build -name *$(BOARD_DIR) | cut -c 14- | cut -d/ -f1 | head -n 1)

#determine MCU by directory in which the board dir is located
MCU := $(shell find ../src/board/ -type d -name *$(BOARD_DIR) | cut -c 15- | cut -d/ -f3 | head -n 1)
