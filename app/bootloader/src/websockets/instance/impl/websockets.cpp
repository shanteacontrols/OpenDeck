...
using namespace opendeck::bootloader::websockets;
...
WebSockets::WebSockets(opendeck::websockets::Hwa& hwa, direct_update_writer::DirectUpdateWriter& direct_update_writer)
    : _hwa(hwa)
...
std::optional<opendeck::websockets::FirmwareUploadAck> WebSockets::handle_command_frame(std::span<const uint8_t> data)
{
