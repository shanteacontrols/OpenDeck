...
namespace io::digital::drivers
{
    class Driver : public DriverBase
    {
        ...
        private:
        static constexpr size_t   ROW_COUNT      = DT_PROP(DT_CHOSEN(opendeck_buttons), rows);
        ...
        std::array<gpio_dt_spec, DT_PROP_LEN(DT_CHOSEN(opendeck_buttons), column_gpios)> _columns = {
#define OPENDECK_BUTTON_MATRIX_SR_COLUMN_GPIO_ENTRY(index, _) GPIO_DT_SPEC_GET_BY_IDX(DT_CHOSEN(opendeck_buttons), column_gpios, index),
            LISTIFY(DT_PROP_LEN(DT_CHOSEN(opendeck_buttons), column_gpios), OPENDECK_BUTTON_MATRIX_SR_COLUMN_GPIO_ENTRY, (, ), _)
