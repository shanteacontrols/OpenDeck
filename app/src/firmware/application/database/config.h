...
namespace database
{
    class Config
    {
        ...
        enum class commonSetting_t : uint8_t
        {
            ACTIVE_PRESET,
            PRESET_PRESERVE,
            CUSTOM_COMMON_SETTING_START,
            CUSTOM_COMMON_SETTING_END = CUSTOM_COMMON_SETTING_START + MAX_CUSTOM_COMMON_SETTINGS,
            UID,
            AMOUNT
        };
    };
