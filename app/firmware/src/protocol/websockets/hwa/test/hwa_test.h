...
namespace opendeck::firmware::protocol::websockets
{
    ...
    class HwaTest : public opendeck::common::protocols::websockets::Hwa
    {
        ...
        /**
         * @brief Queues one binary frame for the WebSockets receive loop.
         *
        ...
        /**
         * @brief Queues one frame for the WebSockets receive loop.
         *
         * @param data Frame payload bytes.
        ...
        /**
         * @brief Queues one receive error for the WebSockets receive loop.
         *
