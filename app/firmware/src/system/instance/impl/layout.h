...
#include "firmware/src/system/instance/impl/custom_ids.h"
...
namespace opendeck::firmware::sys
{
    ...
    class Layout
    {
        ...
        static constexpr size_t I2C_SECTION_COUNT         = 3;
        ...
        static constexpr auto GLOBAL_SECTIONS = zlibs::utils::sysex_conf::make_block(std::array<zlibs::utils::sysex_conf::Section, GLOBAL_SECTION_COUNT>{
            ...
            zlibs::utils::sysex_conf::Section(static_cast<uint16_t>(common_mdns::CUSTOM_HOSTNAME_SIZE),
                                              0,
                                              255),
