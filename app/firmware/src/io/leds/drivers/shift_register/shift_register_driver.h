...
namespace io::leds
{
    ...
    class Driver : public DriverBase
    {
        ...
        /**
         * @brief Sets one shift-register-driven LED output and flushes the register state.
         *
        ...
        private:
        static constexpr size_t register_count = DT_PROP(DT_NODELABEL(opendeck_leds), shift_registers);
