...
namespace opendeck::io::outputs
{
    ...
    class Remap
    {
        ...
        {
#if CONFIG_PROJECT_TARGET_OUTPUT_HAS_REMAP
...
#define OPENDECK_OUTPUT_REMAP_ENTRY(index, _) DT_PROP_BY_IDX(DT_NODELABEL(opendeck_outputs), index_remap, index)
        inline static constexpr std::array<size_t, CONFIG_PROJECT_TARGET_OUTPUT_LOGICAL_COUNT> INDEX_REMAP = {
            LISTIFY(CONFIG_PROJECT_TARGET_OUTPUT_LOGICAL_COUNT, OPENDECK_OUTPUT_REMAP_ENTRY, (, ))
        };
